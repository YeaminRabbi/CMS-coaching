                ...
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="faculty_edit.php?faculty_id=<?= $data['id'] ?>" class="btn btn-primary">Edit</a>
                        
                        <a href="action.php?faculty_delete=<?= $data['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this course?');">Delete</a> 
